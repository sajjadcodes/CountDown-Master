...
class Countdown_Master {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Countdown_Master_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'countdown-master';
	 ...
	 *
	 * - Countdown_Master_Loader. Orchestrates the hooks of the plugin.
	 * - Countdown_Master_i18n. Defines internationalization functionality.
	 * - Countdown_Master_Admin. Defines all hooks for the admin area.
	 * - Countdown_Master_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Countdown_Master_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
